...
const noise4D = (tables: PermTables, x: number, y: number, z: number, w: number): number => {
	...
	if (t0 >= 0) {
		...
		t0 *= t0;
		n0 =
			t0 * t0 * (GRAD4[gi0] * x0 + GRAD4[gi0 + 1] * y0 + GRAD4[gi0 + 2] * z0 + GRAD4[gi0 + 3] * w0);
	}
	...
	if (t1 >= 0) {
		...
		t1 *= t1;
		n1 =
			t1 * t1 * (GRAD4[gi1] * x1 + GRAD4[gi1 + 1] * y1 + GRAD4[gi1 + 2] * z1 + GRAD4[gi1 + 3] * w1);
	}
	...
	if (t2 >= 0) {
		...
		t2 *= t2;
		n2 =
			t2 * t2 * (GRAD4[gi2] * x2 + GRAD4[gi2 + 1] * y2 + GRAD4[gi2 + 2] * z2 + GRAD4[gi2 + 3] * w2);
	}
	...
	if (t3 >= 0) {
		...
		t3 *= t3;
		n3 =
			t3 * t3 * (GRAD4[gi3] * x3 + GRAD4[gi3 + 1] * y3 + GRAD4[gi3 + 2] * z3 + GRAD4[gi3 + 3] * w3);
	}
	...
	if (t4 >= 0) {
		...
		t4 *= t4;
		n4 =
			t4 * t4 * (GRAD4[gi4] * x4 + GRAD4[gi4 + 1] * y4 + GRAD4[gi4 + 2] * z4 + GRAD4[gi4 + 3] * w4);
	}
