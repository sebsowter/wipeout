...
export const stand = (position: THREE.Vector3, texture: THREE.Texture) => {
...
export const road = (spline: THREE.CurvePath<THREE.Vector3>, textures: { [key: string]: THREE.Texture }) => {
  ...
  object3D.add(stand(new THREE.Vector3(28, 4, -4), textures.stand).rotateY(Math.PI));
  object3D.add(stand(new THREE.Vector3(28, 4, 32), textures.stand).rotateY(Math.PI));
